 ...
 */
@WebServlet(name = "NovoPaciente", urlPatterns = {"/NovoPacienteServlet"})
public class NovoPacienteServlet extends HttpServlet {
  ...
  if (mensagens == null) {
      request.getRequestDispatcher("ConfirmarCadastroPaciente.jsp").forward(request, response);
  } else {
      request.setAttribute("mensagens", mensagens);
      request.getRequestDispatcher("cadastroPacienteForm.jsp").forward(request, response);
  }
