...
import br.ufscar.dc.SistemaMedico.forms.NovoConsultaFormBean;
...
public class GravarConsultaServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        NovoConsultaFormBean npfb = (NovoConsultaFormBean) request.getSession().getAttribute("novoConsulta");
        request.getSession().removeAttribute("novoConsulta");
        ...
        Date dataExame = null;
        try {
            dataExame = sdf.parse(npfb.getDataExame());
        ...
        try {
            ...
            c.setCPF(i);
            int j = Integer.parseInt(npfb.getCRM());
            c.setCRM(j);
            c.setDataExame(dataExame);
            c = cdao.gravarConsulta(c);
            request.setAttribute("mensagem", "Consulta registrada com sucesso!");
